...
# 1. CONFIGURATION
# ==========================================
API_TOKEN = '7719279464:AAHcG3fDRHAmX6jH8pTtT2_Zt6CyFhP6--8'
ADMIN_ID = 931275762
...
def get_lang_inline(current_lang):
    ...
    langs = [('en', "English 🇺🇸"), ('pl', "Polski 🇵🇱"), ('ru', "Русский 🇷🇺")]
...
async def admin_action(c: types.CallbackQuery):
    ...
    # Редактируем сообщение, сохраняя кликабельность ссылки через html_text
    final_text = c.message.html_text + f"\n\n{STRINGS[l]['status_final']}<b>{status}</b>"
    await bot.edit_message_text(final_text, ADMIN_ID, c.message.message_id, parse_mode="HTML",
                                disable_web_page_preview=True)


if __name__ == '__main__':
    print("--- Aethe Service Bot is Running ---")
